<section
    x-data="{
        ...
        canScrollNext: false,
        fetchSameCategory() {
            fetch('{{ route('product.same-category', $product->id) }}')
    ...
    x-init="fetchSameCategory()"
    x-show="loading || products.length > 0"
    class="space-y-4 mb-12"
>
    <h2 class="text-xl font-semibold text-gray-900">Mesma Categoria</h2>
    ...
    >
        ...
        <div
            ...
            role="list"
            aria-label="Produtos da mesma categoria"
